...
export default async function Page() {
   ...
   onClick={() => get_analysis()}
    ...
    className="border mb-10 py-3 px-4 flex bg-green-800 text-white rounded-lg px-2 py-1 flex"
  >Generate Personalized Loan</button> */}
  <iframe
    src="https://mortgage-cnvanasftedrhkvt3nlxcz.streamlit.app/?embedded=true"
    height="700"
