...
model_id_mapping = {    "closing":"prebuilt-mortgage.us.closingDisclosure",
                        "loan-app":"prebuilt-mortgage.us.1003",
...
async def uploadDocument(name: str, file_data: UploadFile = File(...)):
    ...
    final = {"id": model_id_mapping.get(name, name), "ref": ref, "fields": fields}
    
    container.create_item(body=final)
