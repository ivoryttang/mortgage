...
export default function ProgressBar(){
    ...
    const steps = [
        ...
        { name: 'Loan Processing', href: '/dashboard/loan-processing'},
...
<ol className="mt-5 mb-5 flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
    ...
    {idx == 0 || idx == 1 || idx == 2 ? <svg className="w-[3.5px] h-[3.5px] sm:w-[22px] sm:h-[22px] me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
            </svg> : <LockClosedIcon className="w-[20px] h-[20px]" />}
            <Link
            key={`${currStep.name}-${idx}`}
            href={currStep.href}>{currStep.name}</Link>
        </span>
    </li>
